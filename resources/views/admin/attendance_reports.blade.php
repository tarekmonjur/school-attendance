                ...
                <div class="card-header" data-background-color="red">
                    <form action="">
                        ...
                        <div class="pull-right">
                            ...
                            <button type="button" data-toggle="collapse" data-target="#demo"  class="btn btn-danger btn-sm search-form-toggle"><i class="fa fa-search"></i>
                                Filter Results
                             </button>
                        ...
                        <div  id="demo" class="collapse" >
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-5">
                                    ...
                                    <label for="start_date" class="control-label">Start Date</label>
                                      <input type="text" class="form-control  datepicker"  date-format="Y-m-d" name="start_date" id="start_date" data-provide="datepicker" placeholder="YYYY-MM-DD" value="" >
                                   </div>
                                </div>
                                <div class="col-sm-12 col-md-5">
                                  <div class="form-group datetimepicker-conatiner">
                                  <label for="end_date" class="control-label">End Date</label>
                                  <input type="text" class="form-control  datepicker"  date-format="Y-m-d" name="end_date" id="end_date" data-provide="datepicker"  placeholder="YYYY-MM-DD" value="" ></div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="pull-right">
                                        <button type="button" data-toggle="collapse" data-target="#demo"  class="btn btn-danger btn-sm search-form-toggle"><i  class="fa fa fa-angle-up"></i>
                                            Close
                                        </button>
                                        <button type="submit" class="btn btn-danger btn-sm" id="filter-results-button"><i
